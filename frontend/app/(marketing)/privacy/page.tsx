  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1A1035]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Privacy Policy</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 dark:text-gray-300">
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">3. Conversation Data</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">4. AI Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">5. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">8. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">9. Security</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">10. Contact</h2>
