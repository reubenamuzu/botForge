...
export default function KnowledgeBasePage() {
  return (
    <article data-docs-content>
      ...
      <h1 className="text-3xl font-bold text-[#1A1035] dark:text-white mb-3">Knowledge Base</h1>
      ...
      <h2 id="what-is-the-knowledge-base" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">What is the knowledge base?</h2>
      ...
      <h2 id="adding-faqs" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">Adding FAQs manually</h2>
      ...
      <h2 id="crawling-a-url" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">Crawling a URL</h2>
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
      ...
      <h2 id="uploading-a-pdf" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">Uploading a PDF</h2>
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
      ...
      <h2 id="how-it-works" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">How it works</h2>
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
      ...
      <h2 id="tips-for-best-results" className="text-xl font-semibold text-[#1A1035] dark:text-white mt-10 mb-3 scroll-mt-20">Tips for best results</h2>
