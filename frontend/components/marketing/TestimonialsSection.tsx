...
export default function TestimonialsSection() {
  return (
    <section className="relative bg-[#F0EDFA] dark:bg-[#0A0518] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <h2 className="mb-10 mt-5 max-w-[600px] text-[34px] font-bold leading-[1.05] tracking-[-0.035em] text-[#1A1035] dark:text-[#F4F1FF] sm:mb-14 sm:text-[42px]">
