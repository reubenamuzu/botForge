...
export async function Topbar() {
  ...
  return (
    <header
      role="banner"
      className="flex h-14 sm:h-16 flex-shrink-0 items-center justify-between border-b border-[#E8E3F5] dark:border-white/[0.08] bg-white dark:bg-[#15102E] px-3 sm:px-6"
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <ThemeToggle />
        {displayName && (
          <span className="hidden max-w-[180px] truncate text-sm font-medium text-[#6B6490] dark:text-[#8B82B0] md:block">
            {displayName}
          </span>
        )}
        <UserButton />
